...
/**
 * An insect who starts from the beginning of the maze and goes to the end.   
 * If insect reaches the fruit and eats it completely, the game ends
 * @author William Hyun
 * */
...
public class Insect {
     ...
     * @return returns the points which the insect must take to get to the fruit fastest 
     * */
